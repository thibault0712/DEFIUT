...
const maxListSize = defineModel('maxListSize', {
  required: true,
  type: Number,
});

const bestUsers = computed(() =>
  store.getters['userList/userList'].slice(0, maxListSize.value),
);
      ...
      <v-table density="comfortable">
        <thead>
          <tr>
            ...
            <th
              class="text-right text-uppercase text-medium-emphasis text-no-wrap"
            >
              Nombre de points
            </th>
          </tr>
